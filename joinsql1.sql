...
t.cusLocation,
tt.productName
from table1 t full outer join table2 tt on t.cusId = tt.cusId
...
t.cusLocation,
tt.productName
from table1 t left join table2 tt on t.cusId = tt.cusId
...
t.cusLocation,
tt.productName
from table1 t right join table2 tt on t.cusId = tt.cusId
